...
@section('contenido')
    <input type="hidden" id="iduserImprimir" name="iduser" value=" {{ Auth::user()->idUsuario }}">
    <style>
        .subir{
            padding: 5px 10px;
            background: #f55d3e;
    ...
    <input type="hidden" id="iduser" name="iduserImprimir" value=" {{ Auth::user()->idUsuario }}">
                                ...
                                <div class="tab-pane active" id="home"><br>
                                    <h4 style="text-align: center">Credenciales de Iniciar Sesion</h4><br>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control" id="rol_user" onkeyup="validacion('rol_user')"  name="rol">
                                                    @foreach($rol as $r)
                                ...
                                <div class="tab-pane" id="profile"><br>
                                    <h4 style="text-align: center">DATOS PERSONALES</h4><br>
                                        ...
                                        <div class="form-group"  >
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="nombre" class="form-control" onkeyup="validacion('nombre')" id="nombre" placeholder="Escriba aqui....">
                                                <span class="help-block"></span>
                                            </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="apellidos" onkeyup="validacion('apellidos')" class="form-control" id="apellidos" placeholder="Escriba aqui....">
                                                <span class="help-block"></span>
                                            </div>
                                        ...
                                        <div class="form-group"  >
                                            ...
                                            <div class="col-sm-7"> <input type="number"  onkeyup="validacion('telefono')" name="telefono" class="form-control" id="telefono" placeholder="Escriba aqui....">
                                                <span class="help-block"></span>
                                            </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-sm-7">
                                                <input type="number" name="dni" class="form-control" onkeyup="validacion('dni')" id="dni" placeholder="Escriba aqui....">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group" >
                                            <label for="inputPassword3" id="contra" class="col-sm-3 control-label">Direccion</label>
                                            <div class="col-sm-7"> <input type="text" name="direccion" onkeyup="validacion('direccion')" class="form-control" id="direccion" placeholder="Escriba aqui....">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group" >
...
<script>
    ...
    $(document).ready(function () {
            ...
            columns: [
                ...
                {"mRender": function ( data, type, row ) {
                        return '<a style="margin-left: 5px" class="btn btn-success btnEdit" data-edit="/Usuarios/'+row.idUsuario +'/edit" ><i class="fa fa-edit text-warning"></i></a>' +
                            '<a style="margin-left: 5px" class="btn btn-danger" onclick="eliminarUsuario('+row.idUsuario +')" ><i class="fa fa-remove text-warning"></i></a>'+
                            ...
                            '<a onclick="Imprimir('+row.idUsuario +');"   style="margin-left: 5px" class="btn btn-dark "><i class="glyphicon glyphicon-print"></i></a>'
      ...
      $('#Registrar').click(function (e) {
          ...
          if(usuario===''||password===''||nombre===''||rol_user===''||apellidos===''||telefono===''
              ||dni===''||direccion===''
          )
              var v1=0,v2=0,v3=0,v4=0,v5=0,v6=0,v7=0,v8=0;
          v1=validacion('usuario');
          v2=validacion('password');
          v3=validacion('rol_user');
          v4=validacion('nombre');
          v5=validacion('apellidos');
    ...
    function validacion(campo){
        ...
        if (campo==='usuario'){
            ...
            if( usuario == null || usuario.length == 0 || /^\s+$/.test(usuario) ) {
                ...
                $('#'+campo).parent().children('span').text("Campo Usuario Obligatorio").show();
        ...
        if (campo==='password'){
            ...
            if( password == null || password.length == 0 || /^\s+$/.test(password) ) {
                ...
                $("#glypcn"+campo).remove();
                $('#'+campo).parent().parent().attr("class", "form-group has-error has-feedback");
                $('#'+campo).parent().children('span').text("Campo Password Obligatorio").show();
                $('#'+campo).parent().append("<span id='glypcn"+campo+"' class='glyphicon glyphicon-remove form-control-feedback'></span>");
                return false;
        ...
        if (campo==='rol_user'){
            rol_user = document.getElementById(campo).selectedIndex;
            if( rol_user == null || rol_user == 0 ) {
                $('#rol_user').parent().parent().attr("class", "form-group has-error");
                return false;
            }
            else{
                $('#rol_user').parent().parent().attr("class", "form-group has-success");
                return true;
        ...
        if (campo==='nombre'){
            ...
            if( usuario == null || usuario.length == 0 || /^\s+$/.test(usuario) ) {
                ...
                $("#glypcn"+campo).remove();
                $('#'+campo).parent().parent().attr("class", "form-group has-error has-feedback");
                $('#'+campo).parent().children('span').text("Campo Nombre Obligatorio").show();
                $('#'+campo).parent().append("<span id='glypcn"+campo+"' class='glyphicon glyphicon-remove form-control-feedback'></span>");
                return false;
        ...
        if (campo==='apellidos'){
            ...
            if( password == null || password.length == 0 || /^\s+$/.test(password) ) {
                ...
                $("#glypcn"+campo).remove();
                $('#'+campo).parent().parent().attr("class", "form-group has-error has-feedback");
                $('#'+campo).parent().children('span').text("Campo Apellidos Obligatorio").show();
                $('#'+campo).parent().append("<span id='glypcn"+campo+"' class='glyphicon glyphicon-remove form-control-feedback'></span>");
                return false;
        ...
        if (campo==='telefono'){
            ...
            if( telefono == null || telefono.length == 0 || /^\s+$/.test(telefono) ) {
                $("#glypcn"+campo).remove();
                $('#'+campo).parent().parent().attr("class", "form-group has-error has-feedback");
                $('#'+campo).parent().children('span').text("Campo Telefono Obligatorio").show();
                $('#'+campo).parent().append("<span id='glypcn"+campo+"' class='glyphicon glyphicon-remove form-control-feedback'></span>");
                return false;
        ...
        if (campo==='dni'){
            ...
            if( dni == null || dni.length == 0 || /^\s+$/.test(dni) ) {
                $("#glypcn"+campo).remove();
                $('#'+campo).parent().parent().attr("class", "form-group has-error has-feedback");
                $('#'+campo).parent().children('span').text("Campo dni Obligatorio").show();
                $('#'+campo).parent().append("<span id='glypcn"+campo+"' class='glyphicon glyphicon-remove form-control-feedback'></span>");
                return false;
        ...
        if (campo==='direccion'){
            ...
            if( password == null || password.length == 0 || /^\s+$/.test(password) ) {
                ...
                $("#glypcn"+campo).remove();
                $('#'+campo).parent().parent().attr("class", "form-group has-error has-feedback");
                $('#'+campo).parent().children('span').text("Campo Direccion Obligatorio").show();
                $('#'+campo).parent().append("<span id='glypcn"+campo+"' class='glyphicon glyphicon-remove form-control-feedback'></span>");
                return false;
        ...
        success: function (response) {
            if (response.length == 0) {
                Swal.fire({
                    type: 'error',
                    title: 'Oops...',
                    text: 'Usuario no Encuestado!',

                });
                return;
            }
            $.each(response, function (index, val) {
                $('#userImprimi').html(val.email);
                $('#Precidente_corte_Imprimir').html(val.Presidente_corte);
                $('#Gerente_Administrativo_Imprimir').html(val.Gerente_Administrativo);

                $('#Magistrado_Imprimir').html(val.magistrados);
                $('#organo_judi_Imprimir').html(val.organo_judicial);
                $('#direccion_Imprimir').html(val.Direccion);
                $('#fecha_programacion_Imprimir').html(val.Fecha_Programacion);
                $('#fecha_ejecucion_Imprimir').html(val.Fecha_Ejecucion);
                //fin de listado administrativa
                $('#personal_total_Imprimir').html(val.Personal_Total);
                $('#observacion_1_Personal_Imprimir').html(val.Obersvaciones);
                $('#observacion_2_Personal_Imprimir').html(val.Observaciones1);
                if (val.Regi_Trabajadores === 1) {
                    $('#imagen1').removeAttr('scr');
                    $('#imagen1').attr('src','{{asset('check.jpg')}}');

                } else if (val.Regi_Magistrado == 2) {
                    $('#imagen2').removeAttr('scr');
                    $('#imagen2').attr('src','{{asset('check.jpg')}}');

                } else if (val.Regi_Trabajadores_1 == 3) {
                    $('#imagen3').removeAttr('scr');
                    $('#imagen3').attr('src','{{asset('check.jpg')}}');
                } else if (val.Regis_Ftocheck == 4) {
                    $('#imagen4').removeAttr('scr');
                    $('#imagen4').attr('src','{{asset('check.jpg')}}');
                }

                //fin de listado personal

                $('#Mesa_Partes_areas_apoyo_Deficiencias_Imprimir').html(val.Mesa_partes_Deficiencias);
                $('#Mesa_Partes_areas_apoyo_Acciones_Imprimir').html(val.Mesa_partes_Accio);
                $('#archivo_areas_apoyo_Deficiencias_Imprimir').html(val.Archivo_Jurisdicionales_Deficiencias);
                $('#archivo_areas_apoyo_Acciones_Imprimir').html(val.Archivo_Juris_Accio);

                $('#Notificaciones_areas_apoyo_Deficiencias_Impirmir').html(val.Notificaciones_Judiciales_Deficiencias);
                $('#Notificaciones_areas_apoyo_Acciones_Imprimir').html(val.Notificaciones_Judiciales_Accio);

                $('#Publicaciones_areas_apoyo_Deficiencias_Impirmir').html(val.Publicacion_Edictos_Deficiencias);
                $('#Publicaciones_areas_apoyo_Archivos_Imprimir').html(val.Publicacion_Edictos_Accio);

                $('#Convenio_reniec_areas_apoyo_Deficiencias_Impirmir').html(val.Convenio_Reniec_Deficiencias);
                $('#Convenio_reniec_areas_apoyo_Acciones_Imprimir').html(val.Convenio_Reniec_Accio);

                $('#Requisitorias_areas_apoyo_Deficiencias_Impirmir').html(val.Requesitos_Deficiencias);
                $('#Requisitorias_areas_apoyo_Acciones_Imprimir').html(val.Requesitos_Accio);

                $('#Otros_areas_apoyo_Deficiencias_Impirmir').html(val.Areas_judiciales_Otros_Deficiencias);
                $('#Otros_areas_apoyo_Acciones_Imprimir').html(val.Areas_judiciales_Otros_Accio);

                $('#subrasarse_areas_apoyo_Deficiencias_Impirmir').html(val.Areas_judiciales_Advertencia_Deficiencias);
                $('#subrasarse_areas_apoyo_Acciones_Imprimir').html(val.Areas_judiciales_Advertencia_Accio);
                //fin de listado de aspectos logisticlos-servicios terzeridos
                $('#Mensajería_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_Mensa_Defi);
                $('#Mensajería_aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_Mensa_Acci);
                $('#Fotocopiado_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_fotocop_Defi);
                $('#Fotocopiado_aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_fotocop_Acci);

                $('#Limpieza_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_linpieza_Defi);
                $('#Limpieza_aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_linpieza_Acci);
                $('#Traducciones_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_Traducc_Defi);
                $('#Traducciones_aspectos_logisticos_Archivos_Imprimir').html(val.Servi_Tercer_Traducc_Acc);

                $('#Publicaciones_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_Publica_Defi);
                $('#Publicaciones_aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_Publica_Acc);
                $('#Arrendamiento_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_Arrenda_Defi);
                $('#Arrendamiento_aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_Arrenda_Acci);

                $('#Mantenimiento_vehiculos_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_Manten_Defi);
                $('#Mantenimiento_vehiculos_aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_Manten_Acc);
                $('#Otros_aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_Otros_Defi);
                $('#Otros_aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_Otros_Acc);
                $('#subrasarse_Aspectos_logisticos_Deficiencias_Imprimir').html(val.Servi_Tercer_Adverten_Defi);
                $('#subrasarse_Aspectos_logisticos_Acciones_Imprimir').html(val.Servi_Tercer_Adverten_Acci);
                //fin lista servicios   terciarios

                $('#Energía_servicio_bascios_Deficiencias_Imprimir').html(val.Servi_Basi_Ener_Elec_Defi);
                $('#Energía_servicio_bascios_Acciones_Imprimir').html(val.Servi_Basi_Ener_Elec_Acc);
                $('#Agua_servicio_bascios_Deficiencias_Imprimir').html(val.Servi_Basi_Agua_Defi);
                $('#Agua_servicio_bascios_Acciones_Imprimir').html(val.Servi_Basi_Agua_Acc);

                $('#Telefonía_servicio_bascios_Deficiencias_Imprimir').html(val.Servi_Basi_Telefo_Inter_Defi);
                $('#Telefonía_servicio_bascios_Acciones_Imprimir').html(val.Servi_Basi_Telefo_Inter_Acci);
                $('#Otros_servicios_basicos_Deficiencias_Imprimir').html(val.Servi_Basi_Otros_Defi);
                $('#Otros_servicios_basicos_Acciones_Imprimir').html(val.Servi_Basi_Otros_Acci);
                $('#subrasarse_servicios_basicos_Deficiencias_Imprimir').html(val.Servi_Basi_Adver_Defi);
                $('#subrasarse_servicios_basicos_Acciones_Imprimir').html(val.Servi_Basi_Adver_Acci);
                //servicios basicos

                $('#Armarios_mobiliario_Deficiencias_Imprimir').html(val.Mobi_Armarios_Archiva_Defi);
                $('#Armarios_mobiliario_Acciones_Imprimir').html(val.Mobi_Armarios_Archiva_Acci);
                $('#Estantería_mobiliario_Deficiencias_Imprimir').html(val.Mobi_Estanteria_Metalica_Defi);
                $('#Estantería_mobiliario_Acciones_Imprimir').html(val.Mobi_Estanteria_Metalica_Acci);

                $('#Escritorios_mobiliario_Deficiencias_Imprimir').html(val.Mobi_Escritorio_mesas_Defi);
                $('#Escritorios_mobiliario_Acciones_Imprimir').html(val.Mobi_Escritorio_mesas_Acci);
                $('#Sillas_mobiliario_Deficiencias_Imprimir').html(val.Mobi_sillas_sillones_Defi);
                $('#Sillas_mobiliario_Archivos_Imprimir').html(val.Mobi_sillas_sillones_Acci);

                $('#Módulos_computadoras_mobiliarios_Deficiencias_Imprimir').html(val.Mobi_Modulos_Defi);
                $('#Módulos_computadoras_mobiliarios_Acciones_Imprimir').html(val.Mobi_Modulos_Acci);
                $('#otros_mobiliario_Deficiencias_Imprimir').html(val.Mobi_Otros_Defi);
                $('#otros_mobiliario_Acciones_Imprimir').html(val.Mobi_Otros_Acci);
                $('#subrasarse_mobiliarios_Deficiencias_Imprimir').html(val.Advertencia_Mobiliario_Defi);
                $('#subrasarse_mobiliarios_acciones_Imprimir').html(val.Advertencia_Mobiliario_Acci);
                //fin lista mobiliarios

                $('#Papel_suministro_Deficiencias_Imprimir').html(val.sumi_Papel_Defi);
                $('#Papel_suministro_Acciones_Imprimir').html(val.sumi_Papel_Acci);
                $('#Bolígrafos_suministro_Deficiencias_Imprimir').html(val.sumi_Boligrafos_Grapas_Defi);
                $('#Bolígrafos_suministro_Acciones_Imprimir').html(val.sumi_Boligrafos_Grapas_Acci);

                $('#Cinta_suministro_Deficiencias_Imprimir').html(val.Sumi_Cinta_Impresora_Defi);
                $('#Cinta_suministro_Acciones_Imprimir').html(val.Sumi_Cinta_Impresora_Acci);
                $('#Carátulas_suministro_Deficiencias_Imprimir').html(val.Sumi_Caratulas_Defi);
                $('#Carátulas_suministro_Acciones_Imprimir').html(val.Sumi_Caratulas_Acci);

                $('#Peruano_suministro_Deficiencias_Imprimir').html(val.Sumi_Peruano_Defi);
                $('#Peruano_suministro_Archivos_Imprimir').html(val.Sumi_Peruano_Acci);
                $('#Otros_suministro_Deficiencias_Imprimir').html(val.Sumi_Otros_Defi);
                $('#Otros_suministro_Acciones_Imprimir').html(val.Sumi_Otros_Acci);

                $('#subrasarse_suministro_Deficiencias_Imprimir').html(val.Sumi_Advertencia_Defi);
                $('#subrasarse_suministro_Acciones_Imprimir').html(val.Sumi_Advertencia_Acci);
                //fin lista sumunistro

                $('#Computadoras_informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_Compu_Defi);
                $('#Computadoras_informaticos_Acciones_Imprimir').html(val.Aspect_Infor_Compu_Acc);
                $('#Impresoras_informaticos_Deficiencias_Imprimir').html(val.Aspect_infor_Impres_Defi);
                $('#Impresoras_informaticos_Acciones_Imprimir').html(val.Aspect_infor_Impres_Acc);

                $('#Fax_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_Fax_Defi);
                $('#Fax_informaticos_Acciones_Imprimir').html(val.Aspect_Infor_Fax_Acc);
                $('#Mantenimiento_equipos_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_Mante_Equi_Defi);
                $('#Mantenimiento_equipos_Informaticos_Acciones_Imprimir').html(val.Aspect_Infor_Mante_Equi_Acci);

                $('#UPS_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_Ups_Defi);
                $('#UPS_Informaticos_Acciones_Imprimir').html(val.Aspect_Infor_Ups_Acc);
                $('#supresor_picos_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_Supresor_Defi);
                $('#supresor_picos_Informaticos_Acciones_Imprimir').html(val.Aspect_Infor_Supresor_Acc);

                $('#Correo_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_correo_Defi);
                $('#Correo_Informaticos_Acciones_Imprimir').html(val.Aspect_Infor_correo_Acc);
                $('#sistemas_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Sistemas_Informaticos);
                $('#sistemas_Informaticos_Acciones_Imprimir').html(val.Aspect_Sistemas_Informaticos_Acc);

                $('#Redes_Informáticos_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Redes_Informaticos_Defi);
                $('#Redes_Informáticos_Informaticos_Acciones_Imprimir').html(val.Aspect_Redes_Informaticos_Acc);
                $('#Otros_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_Otros_Defi);
                $('#Otros_Informaticos_Acciones_Imprimir').html(val.Aspect_Infor_Otros_Acc);
                $('#subrasarse_Informaticos_Deficiencias_Imprimir').html(val.Aspect_Infor_Advert_Defi);
                $('#subrasarse_Informaticos_Acciones_Imprimir').html(val.Aspect_Infor_Advert_Acc);
                //fin lista aspectos informaticos

                $('#Aspectos_seguridad_detectorM_Deficiencias_Imprimir').html(val.Aspecto_segu_Detectores_metal_Defi);
                $('#Aspectos_seguridad_detectorM_Acciones_Imprimir').html(val.Aspecto_segu_Detectores_metal_Acc);

                $('#Aspectos_seguridad_Extintores_Deficiencias_Imprimir').html(val.Aspecto_segu_Extintotores_Defi);
                $('#Aspectos_seguridad_Extintores_Acciones_Imprimir').html(val.Aspecto_segu_Extintotores_Acc);

                $('#Aspectos_seguridad_Mangueras_Deficiencias_Imprimir').html(val.Aspecto_segu_Mangueras_Defi);
                $('#Aspectos_seguridad_Mangueras_Acciones_Imprimir').html(val.Aspecto_segu_Mangueras_Acc);

                $('#Aspectos_seguridad_Otros_Deficiencias_Imprimir').html(val.Aspecto_segu_Otros_Defi);
                $('#Aspectos_seguridad_Otros_Acciones_Imprimir').html(val.Aspecto_segu_Otros_Acc);

                $('#subrasarse_Aspectos_seguridad_Deficiencias_Imprimir').html(val.Aspecto_Segu_Advertencia_Defi);
                $('#subrasarse_Aspectos_seguridad_Acciones_Imprimir').html(val.Aspecto_Segu_Advertencia_Acc);

                //fin lista aspectos de seguridad


                $('#Aspectos_generales_Estructuras_Deficiencias_Imprimir').html(val.Aspec_Gene_Estructuras_Defi);
                $('#Aspectos_generales_Estructuras_Acciones_Imprimir').html(val.Aspec_Gene_Estructuras_Acc);
                $('#Aspectos_generales_Puertas_Deficiencias_Imprimir').html(val.Aspec_Gene_Puertas_Defi);
                $('#Aspectos_generales_Puertas_Acciones_Imprimir').html(val.Aspec_Gene_Puertas_Acc);

                $('#Aspectos_generales_Ventanas_Deficiencias_Imprimir').html(val.Aspect_Gene_Ventanas_Defi);
                $('#Aspectos_generales_Ventanas_Acciones_Imprimir').html(val.Aspect_Gene_Ventanas_Acc);

                $('#Aspectos_generales_Pisos_Deficiencias_Imprimir').html(val.Aspect_Gene_Pisos_Defi);
                $('#Aspectos_generales_Pisos_Acciones_Imprimir').html(val.Aspect_Gene_Pisos_Acc);
                $('#Aspectos_generales_Pintura_Deficiencias_Imprimir').html(val.Aspect_Gene_Pintura_Defi);
                $('#Aspectos_generales_Pintura_Acciones_Imprimir').html(val.Aspect_Gene_Pintura_Acc);


                $('#Aspectos_generales_Instalaciones_Sanitarias_Deficiencias_Imprimir').html(val.Aspect_Instalaciones_sanitarias_Defi);
                $('#Aspectos_generales_Instalaciones_Sanitarias_Acciones_Imprimir').html(val.Aspect_Instalaciones_sanitarias_Acc);
                $('#Aspectos_generales_Instalaciones_Eléctricas_Deficiencias_Imprimir').html(val.Aspect_Gene_Electricas_Defi);
                $('#Aspectos_generales_Instalaciones_Eléctricas_Acciones_Imprimir').html(val.Aspect_Gene_Electricas_Acc);

                $('#Aspectos_generales_brinda_Seguridad_Deficiencias_Imprimir').html(val.Aspect_Gene_Brinsa_Seguridad_Defi);
                $('#Aspectos_generales_brinda_Seguridad_Acciones_Imprimir').html(val.Aspect_Gene_Brinsa_Seguridad_Acc);
                $('#Aspectos_generales_Mantenimiento_local_Deficiencias_Imprimir').html(val.Aspect_Gene_manteni_local_defi);
                $('#Aspectos_generales_Mantenimiento_local_Acciones_Imprimir').html(val.Aspect_Gene_manteni_local_Acci);

                $('#Aspectos_generales_Otros_Deficiencias_Imprimir').html(val.Aspect_Gene_Otros_Defi);
                $('#Aspectos_generales_Otros_Acciones_Imprimir').html(val.Aspect_Gene_Otros_Acc);
                $('#subrasarse_Aspectos_generales_Deficiencias_Imprimir').html(val.Aspect_Gene_Advertencia_Difi);
                $('#subrasarse_Aspectos_generales_Acciones_Imprimir').html(val.Aspect_Gene_Advertencia_Acc);

                $('#Aspectos_generales_ALQUILADO_Imprimir').html(val.Aspect_Gene_Alquilado_1);
                $('#Aspectos_generales_ALQUILADO1_Imprimir').html(val.Aspect_Gene_Alquilado_2);
                $('#Aspectos_generales_ALQUILADO2_Imprimir').html(val.Aspect_Gene_Alquilado_3);

                $('#Aspectos_generales_CEDIDO_Imprimir').html(val.Aspect_Gene_Cedido_1);
                $('#Aspectos_generales_CEDIDO1_Imprimir').html(val.Aspect_Gene_Cedido_2);
                $('#Aspectos_generales_CEDIDO2_Imprimir').html(val.Aspect_Gene_Cedido_3);

                //fin lista servicios judiciales
                if (val.Condicion_uno == 's') {
                    $('#servicio_judiciales_SI_1_Impremir').html(val.Condicion_uno);
                } else {
                    $('#servicio_judiciales_NO_1_Impremir').html(val.Condicion_uno);
                }
                $('#servicio_judiciales_Observaciones_1').html(val.Condicion_uno_Observa);

                if (val.Condicion_dos == 's') {
                    $('#servicio_judiciales_SI_2_Impremir').html(val.Condicion_dos);
                } else {
                    $('#servicio_judiciales_NO_2_Impremir').html(val.Condicion_dos);
                }
                $('#servicio_judiciales_Observaciones_2_Impremir').html(val.Condicion_dos_Observa);

                if (val.Condicion_tres == 's') {
                    $('#servicio_judiciales_SI_3_Impremir').html(val.Condicion_tres);
                } else {
                    $('#servicio_judiciales_NO_3_Imprimir').html(val.Condicion_tres);
                }
                $('#servicio_judiciales_Observaciones_3_Impremir').html(val.Condicion_tres_Observa);

                if (val.Condicion_cuatro == 's') {
                    $('#servicio_judiciales_SI_4_Impresora_Imprimir').html(val.Condicion_tres);
                } else {
                    $('#servicio_judiciales_NO_4_Impresora_Imprimir').html(val.Condicion_tres);
                }
                $('#servicio_judiciales_Observaciones_4_Imprimir').html(val.Condicion_cuatro_Observa);
                $('#respuesta_negativa_Impremir').html(val.respuesta_negativa);
                $('#servicio_judiciales_acciones1_Imprimir').html(val.Acciones_Adoptadas_uno);
                $('#servicio_judiciales_acciones2_Imprimir').html(val.Acciones_Adoptadas_dos);
                $('#servicio_judiciales_acciones3_Imprimir').html(val.Acciones_Adoptadoas_tres);
                $('#servicio_judiciales_acciones4_Imprimir').html(val.Acciones_Adoptadas_cuatro);
                $('#servicio_judiciales_acciones5_Imprimir').html(val.Acciones_Adoptadas_cinco);

                //fin lista servicio Judicial

                if (val.auxi_Judi_Condi_uno == 's') {
                    $('#auxilio_genereal_SI_1_Imprimir').html(val.auxi_Judi_Condi_uno);

                } else {
                    $('#auxilio_genereal_NO_1_Imprimir').html(val.auxi_Judi_Condi_uno);
                }
                $('#auxilio_genereal_Observaciones_1_Imprimir').html(val.auxi_Judi_Condici_uno_Observa);

                if (val.auxi_Judi_Condici_dos == 's') {
                    $('#auxilio_genereal_SI_2_1_Impremir').html(val.auxi_Judi_Condici_dos);

                } else {
                    $('#auxilio_genereal_NO_2_1_Impremir').html(val.auxi_Judi_Condici_dos);
                }
                $('#auxilio_genereal_Observaciones_2_1_Imprimir').html(val.auxi_Judi_Condici_dos_Observa);

                if (val.Condici_dos_uno == 's') {
                    $('#auxilio_genereal_SI_2_2_Imprimir').html(val.Condici_dos_uno);

                } else {
                    $('#auxilio_genereal_NO_2_2_Imprimir').html(val.Condici_dos_uno);
                }
                $('#auxilio_genereal_Observaciones_2_2_Imprimir').html(val.auxi_Judi_Condici_dos_uno_Observa);

                if (val.auxi_Judi_Condici_tres == 's') {
                    $('#auxilio_genereal_SI_3_Imprimir').html(val.auxi_Judi_Condici_tres);

                } else {
                    $('#auxilio_genereal_NO_3_Imprimir').html(val.auxi_Judi_Condici_tres);
                }
                $('#auxilio_genereal_Observaciones_3_Imprimir').html(val.auxi_Judi_Condici_tres_Observa);

                if (val.auxi_Judi_Condici_cuatro == 's') {
                    $('#uxilio_genereal_SI_4_Imprimir').html(val.auxi_Judi_Condici_cuatro);

                } else {
                    $('#auxilio_genereal_NO_4_Imprimir').html(val.auxi_Judi_Condici_cuatro);
                }
                $('#auxilio_genereal_Observaciones_4_Imprimir').html(val.auxi_Judi_Condici_cuatro_Observa);

                if (val.auxi_Judi_Condici_cinco == 's') {
                    $('#auxilio_genereal_SI_5_Imprimir').html(val.auxi_Judi_Condici_cinco);

                } else {
                    $('#auxilio_genereal_NO_5_Imprimir').html(val.auxi_Judi_Condici_cinco);
                }
                $('#auxilio_genereal_Observaciones_5_Imprimir').html(val.auxi_Judi_Condici_cinco_Observa);

                if (val.auxi_Judi_Condici_seis == 's') {
                    $('#auxilio_genereal_SI_6_Imprimir').html(val.auxi_Judi_Condici_seis);

                } else {
                    $('#auxilio_genereal_NO_6_Imprimir').html(val.auxi_Judi_Condici_seis);
                }
                $('#auxilio_genereal_Observaciones_6_Imprimir').html(val.auxi_Judi_Condici_seis_Observa);

                $('#auxilio_genereal_Acciones_1_Imprimir').html(val.auxi_Judi_Acciones_uno);
                $('#auxilio_genereal_Acciones_2_Imprimir').html(val.auxi_Judi_Acciones_dos);
                $('#auxilio_genereal_Acciones_3_Imprimir').html(val.auxi_Judi_Acciones_tres);

                //fin lista auxilio judicial

                if (val.Peritos_Condicion_uno == 's') {
                    $('#Peritos_judiciales_SI_1_Imprimir').html(val.Peritos_Condicion_uno);
                } else {
                    $('#Peritos_judiciales_NO_1_Imprimir').html(val.Peritos_Condicion_uno);

                }
                $('#Peritos_judiciales_Obserbaciones_1_Imprimir').html(val.Peritos_Condicion_uno_observa);

                if (val.Peritos_Condicion_dos == 's') {
                    $('#Peritos_judiciales_SI_2_1_Imprimir').html(val.Peritos_Condicion_dos);
                } else {
                    $('#Peritos_judiciales_NO_2_1_Impremir').html(val.Peritos_Condicion_dos);

                }
                $('#Peritos_judiciales_Obserbaciones_1_Imprimir').html(val.Peritos_Condicion_dos_Observa);

                if (val.Peritos_Condicion_dos_uno == 's') {
                    $('#Peritos_judiciales_SI_2_2_Imprimir').html(val.Peritos_Condicion_dos_uno);
                } else {
                    $('#Peritos_judiciales_NO_2_2_Imprimir').html(val.Peritos_Condicion_dos_uno);

                }
                $('#Peritos_judiciales_Obserbaciones_2_2Imprimir').html(val.Peritos_Condicion_dos_uno_Observa);

                if (val.Peritos_Condicion_tres == 's') {
                    $('#Peritos_judiciales_SI_3_Imprimir').html(val.Peritos_Condicion_tres);
                } else {
                    $('#Peritos_judiciales_NO_3_Imprimir').html(val.Peritos_Condicion_tres);

                }
                $('#Peritos_judiciales_Obserbaciones_3_Imprimir').html(val.Peritos_Condicion_tres_Observa);

                if (val.Peritos_Condicion_cuatro == 's') {
                    $('#Peritos_judiciales_SI_4_Imprimir').html(val.Peritos_Condicion_cuatro);
                } else {
                    $('#Peritos_judiciales_NO_4_Imprimir').html(val.Peritos_Condicion_cuatro);

                }
                $('#Peritos_judiciales_Obserbaciones_4_Imprimir').html(val.Peritos_Condicion_cuatro_Observa);


                if (val.Peritos_Condicion_cinco == 's') {
                    $('#Peritos_judiciales_SI_5_Imprimir').html(val.Peritos_Condicion_cinco);
                } else {
                    $('#Peritos_judiciales_NO_5_Imprimir').html(val.Peritos_Condicion_cinco);

                }
                $('#Peritos_judiciales_Obserbaciones_5_Imprimir').html(val.Peritos_Condicion_cinco_Observa);


                if (val.Peritos_Condicion_seis == 's') {
                    $('#Peritos_judiciales_SI_6_1_Imprimir').html(val.Peritos_Condicion_seis);
                } else {
                    $('#Peritos_judiciales_NO_6_1_Impremir').html(val.Peritos_Condicion_seis);

                }
                $('#Peritos_judiciales_Obserbaciones_6_1_Imprimir').html(val.Peritos_Condicion_seis_Observa);

                if (val.Peritos_Condicion_seis_uno == 's') {
                    $('#Peritos_judiciales_SI_6_2_Imprimir').html(val.Peritos_Condicion_seis_uno);
                } else {
                    $('#Peritos_judiciales_NO_6_2_Imprimir').html(val.Peritos_Condicion_seis_uno);

                }
                $('#Peritos_judiciales_Obserbaciones_6_2_Imprimir').html(val.Peritos_Condicion_seis_uno_Observa);


                if (val.Peritos_Condiciom_siete == 's') {
                    $('#Peritos_judiciales_SI_7_Imprimir').html(val.Peritos_Condiciom_siete);
                } else {
                    $('#Peritos_judiciales_NO_7_Imprimir').html(val.Peritos_Condiciom_siete);

                }
                $('#Peritos_judiciales_Obserbaciones_7_Imprimir').html(val.Peritos_Condicion_siete_Observa);

                $('#Peritos_judiciales_Acciones_1_Imprimir').html(val.Peritos_Acciones_uno);
                $('#Peritos_judiciales_Acciones_2_Imprimir').html(val.Peritos_Acciones_dos);

                //fin lista peritos judicial

                if (val.Cuerpos_Condicion_uno == 's') {
                    $('#Cuerpo_delito_efectos_SI_1_Imprimir').html(val.Cuerpos_Condicion_uno);

                } else {
                    $('#Cuerpo_delito_efectos_NO_1_Imprimir').html(val.Cuerpos_Condicion_uno);
                }
                $('#Cuerpo_delito_efectos_Observaciones_1_Imprimir').html(val.Cuerpos_Condicion_uno_Observa);

                if (val.Cuerpos_Condicion_dos == 's') {
                    $('#Cuerpo_delito_efectos_SI_2_1_Imprimir').html(val.Cuerpos_Condicion_dos);

                } else {
                    $('#Cuerpo_delito_efectos_NO_2_1_Impremir').html(val.Cuerpos_Condicion_dos);
                }
                $('#Cuerpo_delito_efectos_Observaciones_2_1_Imprimir').html(val.Cuerpos_Condicion_dos_Observa);

                if (val.Cuerpos_Condicion_dos_uno == 's') {
                    $('#Cuerpo_delito_efectos_SI_2_2_Imprimir').html(val.Cuerpos_Condicion_dos_uno);

                } else {
                    $('#Cuerpo_delito_efectos_NO_2_2_Imprimir').html(val.Cuerpos_Condicion_dos_uno);
                }
                $('#Cuerpo_delito_efectos_Observaciones_2_2_Imprimir').html(val.Cuerpos_Condicion_dos_uno_Observa);
                if (val.Cuerpos_Condicion_tres == 's') {
                    $('#Cuerpo_delito_efectos_SI_3_Imprimir').html(val.Cuerpos_Condicion_tres);

                } else {
                    $('#Cuerpo_delito_efectos_NO_3_Imprimir').html(val.Cuerpos_Condicion_tres);
                }
                $('#Cuerpo_delito_efectos_Observaciones_3_Imprimir').html(val.Cuerpos_Condicion_tres_Observa);

                if (val.Cuerpos_Condiciones_cuatro == 's') {
                    $('#Cuerpo_delito_efectos_SI_4_1_Imprimir').html(val.Cuerpos_Condiciones_cuatro);

                } else {
                    $('#Cuerpo_delito_efectos_NO_4_1_Impremir').html(val.Cuerpos_Condiciones_cuatro);
                }
                $('#Cuerpo_delito_efectos_Observaciones_4_1_Imprimir').val(val.Cuerpos_Condiciones_cuatro_Observa);


                if (val.Cuerpos_Condiciones_cuatro_uno == 's') {
                    $('#Cuerpo_delito_efectos_SI_4_2_Imprimir').html(val.Cuerpos_Condiciones_cuatro);

                } else {
                    $('#Cuerpo_delito_efectos_NO_4_2_Imprimir').html(val.Cuerpos_Condiciones_cuatro);
                }
                $('#Cuerpo_delito_efectos_Observaciones_4_2_Imprimir').html(val.Cuerpos_Condiciones_cuatro_Observa);


                if (val.Cuerpos_Condicion_cinco == 's') {
                    $('#Cuerpo_delito_efectos_SI_5_Imprimir').html(val.Cuerpos_Condicion_cinco);

                } else {
                    $('#Cuerpo_delito_efectos_NO_5_Imprimir').html(val.Cuerpos_Condicion_cinco);
                }
                $('#Cuerpo_delito_efectos_Observaciones_5_Imprimir').html(val.Cuerpos_Condicion_cinco_Observa);
                ...
                if (val.Cuerpos_Condicion_Seis == 's') {
                    $('#Cuerpo_delito_efectos_SI_6_Imprimir').html(val.Cuerpos_Condicion_Seis);

                } else {
                    $('#Cuerpo_delito_efectos_NO_6_Imprimir').html(val.Cuerpos_Condicion_Seis);
                }
                $('#Cuerpo_delito_efectos_Observaciones_6_Imprimir').html(val.Cuerpos_Condicion_Seis_Observa);

                $('#Cuerpo_delito_efectos_ACCIONES_1_Imprimir').html(val.Cuerpos_Acciones_uno);
                $('#Cuerpo_delito_efectos_ACCIONES_2_Imprimir').html(val.Cuerpos_Acciones_dos);
                $('#Cuerpo_delito_efectos_ACCIONES_3_Imprimir').html(val.Cuerpos_Acciones_tres);

                //fin lista cuerpo del delito
                if (val.Recau_Comprobantes_pago == 's') {
                    $('#Recaudacion_judicial_SI_1_Imprimir').html(val.Recau_Comprobantes_pago);

                } else {
                    $('#Recaudacion_judicial_NO_1_Impremir').html(val.Recau_Comprobantes_pago);
                }

                if (val.Recau_Sello_Utilzada == 's') {
                    $('#Recaudacion_judicial_SI_1_1_Imprimir').html(val.Recau_Sello_Utilzada);

                } else {
                    $('#Recaudacion_judicial_NO_1_1_Imprimir').html(val.Recau_Sello_Utilzada);
                }

                if (val.Recau_Sello_fechador == 's') {
                    $('#Recaudacion_judicial_SI_1_2_Imprimir').html(val.Recau_Sello_fechador);

                } else {
                    $('#Recaudacion_judicial_NO_1_2').html(val.Recau_Sello_fechador);
                }

                if (val.Recau_Datos_Presenta == 's') {
                    $('#Recaudacion_judicial_SI_1_3_Imprimir').html(val.Recau_Datos_Presenta);

                } else {
                    $('#Recaudacion_judicial_NO_1_3_Imprimir').html(val.Recau_Datos_Presenta);
                }

                if (val.Recaudacion_Cumplen_Prestar == 's') {
                    $('#Recaudacion_judicial_SI_1_4_Imprimir').html(val.Recaudacion_Cumplen_Prestar);

                } else {
                    $('#Recaudacion_judicial_NO_1_4_Imprimir').html(val.Recaudacion_Cumplen_Prestar);
                }

                if (val.Recau_Sistema_Validacion == 's') {
                    $('#Recaudacion_judicial_S1_2_Imprimir').html(val.Recau_Sistema_Validacion);

                } else {
                    $('#Recaudacion_judicial_NO_2_Impremir').html(val.Recau_Sistema_Validacion);
                }

                if (val.Reca_Respuesta_Negativa == 's') {
                    $('#Recaudacion_judicial_S1_2_1_Imprimir').html(val.Reca_Respuesta_Negativa);

                } else {
                    $('#Recaudacion_judicial_NO_2_1_Impremir').html(val.Reca_Respuesta_Negativa);
                }

                if (val.Reca_Respuesta_Afirmativa == 's') {
                    $('#Recaudacion_judicial_S1_2_2_Imprimir').html(val.Reca_Respuesta_Negativa);

                } else {
                    $('#Recaudacion_judicial_NO_2_2_Impremir').html(val.Reca_Respuesta_Negativa);
                }
                if (val.Reca_Nota_Situacion == 's') {
                    $('#Recaudacion_judicial_S1_2_3_Imprimir').html(val.Reca_Respuesta_Negativa);

                } else {
                    $('#Recaudacion_judicial_NO_2_3_Imprimir').html(val.Reca_Respuesta_Negativa);
                }
                $('#Recaudacion_judicial_periodicidad_Imprimir').html(val.recaud_judicial_Perio);
                $('#Recaudacion_judicial_Oficio_Imprimir').html(val.recaud_judicial_Num_Ofici);
                $('#Recaudacion_judicial_fecha_Imprimir').html(val.recaud_judicial_Fecha);

                $('#Recaudacion_judicial_afirmativa_periodicidad_Imprimir').html(val.recaudacion_judicial_Afirma_Periodi);
                $('#Recaudacion_judicial_afirmativa_Oficio_Imprimir').html(val.recauda_judicial_Afirma_Num_Oficio);
                $('#Recaudacion_judicial_afirmativa_fecha_Imprimir').html(val.ecauda_judicial_Afirma_Fecha);


                if (val.Recaudacion_Expedientes_fenecidos == 's') {
                    $('#Recaudacion_judicial_S1_3_Imprimir').html(val.Recaudacion_Expedientes_fenecidos);

                } else {
                    $('#Recaudacion_judicial_NO_3_Impremir').html(val.Recaudacion_Expedientes_fenecidos);
                }

                if (val.Recaudacion_Resp_Afirmativa == 's') {
                    $('#Recaudacion_judicial_S1_3_1_Imprimir').html(val.Recaudacion_Resp_Afirmativa);

                } else {
                    $('#Recaudacion_judicial_NO_3_1_Impremir').html(val.Recaudacion_Resp_Afirmativa);
                }


                if (val.Recaudacion_Nota_situcacion_3 == 's') {
                    $('#Recaudacion_judicial_S1_3_2_Imprimir').html(val.Recaudacion_Nota_situcacion_3);

                } else {
                    $('#Recaudacion_judicial_NO_3_2_Impremir').html(val.Recaudacion_Nota_situcacion_3);
                }

                if (val.Reca_Cumplen_Verificar == 's') {
                    $('#Recaudacion_judicial_S1_4_Imprimir').html(val.Reca_Cumplen_Verificar);

                } else {
                    $('#Recaudacion_judicial_NO_4_Impremir').html(val.Reca_Cumplen_Verificar);
                }
                if (val.Reca_Presentase_Aranceles_Judiciales == 's') {
                    $('#Recaudacion_judicial_S1_4_1_Imprimir').html(val.Reca_Presentase_Aranceles_Judiciales);

                } else {
                    $('#Recaudacion_judicial_NO_4_1_Imprimir').html(val.Reca_Presentase_Aranceles_Judiciales);
                }

                if (val.Reca_Presentacion_Derechos_Notificacion == 's') {
                    $('#Recaudacion_judicial_SI_5_Imprimir').html(val.Reca_Presentacion_Derechos_Notificacion);

                } else {
                    $('#Recaudacion_judicial_NO_5_Impremir').html(val.Reca_Presentacion_Derechos_Notificacion);
                }
                //fin lista recaudacion judicial

                if (val.Condicion_uno_Libro_Registros == 's') {
                    $('#Cobransas_certificados_SI_1_Imprimir').html(val.Condicion_uno_Libro_Registros);

                } else {
                    $('#Cobransas_certificados_NO_1_Impremir').html(val.Condicion_uno_Libro_Registros);
                }

                if (val.Condicion_uno_Respuesta_Afirmativa == 's') {
                    $('#Cobransas_certificados_SI_1_1_Imprimir').html(val.Condicion_uno_Respuesta_Afirmativa);

                } else {
                    $('#Cobransas_certificados_NO_1_1_Imprimir').html(val.Condicion_uno_Respuesta_Afirmativa);
                }
                if (val.Condicion_dos_Respuesta_Negativa == 's') {
                    $('#Cobransas_certificados_SI_2_Imprimir').html(val.Condicion_dos_Respuesta_Negativa);

                } else {
                    $('#Cobransas_certificados_N0_2_Imprimir').html(val.Condicion_dos_Respuesta_Negativa);
                }

                if (val.Condicion_dos_Ultimos_Meses == 's') {
                    $('#Cobransas_certificados_SI_2_1_Imprimir').html(val.Condicion_dos_Ultimos_Meses);

                } else {
                    $('#Cobransas_certificados_N0_2_1_Imprimir').html(val.Condicion_dos_Ultimos_Meses);
                }

                if (val.Condicion_Dos_A == 's') {
                    $('#Cobransas_certificados_SI_2_2_Imprimir').html(val.Condicion_Dos_A);

                } else {
                    $('#Cobransas_certificados_N0_2_2_Imprimir').html(val.Condicion_Dos_A);
                }

                if (val.Condicion_Dos_B == 's') {
                    $('#Cobransas_certificados_SI_2_3_Imprimir').html(val.Condicion_Dos_B);

                } else {
                    $('#Cobransas_certificados_N0_2_3_Imprimir').html(val.Condicion_Dos_B);
                }

                if (val.Condicion_Dos_C == 's') {
                    $('#Cobransas_certificados_SI_2_4_Imprimir').html(val.Condicion_Dos_C);

                } else {
                    $('#Cobransas_certificados_N0_2_4_Imprimir').html(val.Condicion_Dos_C);
                }

                if (val.Condicion_Dos_D == 's') {
                    $('#Cobransas_certificados_SI_2_5_Imprimir').html(val.Condicion_Dos_D);

                } else {
                    $('#Cobransas_certificados_N0_2_5_Imprimir').html(val.Condicion_Dos_D);
                }

                if (val.Condicion_tres_Precidencia_corte == 's') {
                    $('#Cobransas_certificados_SI_3_Imprimir').html(val.Condicion_tres_Precidencia_corte);

                } else {
                    $('#Cobransas_certificados_NO_3_Imprimir').html(val.Condicion_tres_Precidencia_corte);
                }
                if (val.Condicion_tres_Cargo_Remision == 's') {
                    $('#Cobransas_certificados_SI_3_1_Imprimir').html(val.Condicion_tres_Cargo_Remision);

                } else {
                    $('#Cobransas_certificados_NO_3_1_Imprimir').html(val.Condicion_tres_Cargo_Remision);
                }

                if (val.Condicion_tres_Nota == 's') {
                    $('#Cobransas_certificados_SI_3_2_Imprimir').html(val.Condicion_tres_Nota);

                } else {
                    $('#Cobransas_certificados_NO_3_2_Imprimir').html(val.Condicion_tres_Nota);
                }
                if (val.Condicion_cuatro == 's') {
                    $('#Cobransas_certificados_SI_4_Imprimir').html(val.Condicion_cuatro);

                } else {
                    $('#Cobransas_certificados_NO_4_Imprimir').html(val.Condicion_cuatro);
                }
                if (val.Condicion_sinco == 's') {
                    $('#Cobransas_certificados_SI_5_Imprimir').html(val.Condicion_sinco);

                } else {
                    $('#Cobransas_certificados_NO_5_Imprimir').html(val.Condicion_sinco);
                }
                if (val.Condicion_seis == 's') {
                    $('#Cobransas_certificados_SI_6_Imprimir').html(val.Condicion_sinco);

                } else {
                    $('#Cobransas_certificados_NO_6_Imprimir').html(val.Condicion_sinco);
                }

                $('#Cobransas_certificados_ACCIONES_1_Imprimir').html(val.Cobranza_acciones_uno);
                $('#Cobransas_certificados_ACCIONES_2_Imprimir').html(val.Cobranzas_acciones_dos);
                $('#Cobransas_certificados_ACCIONES_3_Imprimir').html(val.Cobranzas_acciones_tres);
...
function imprimir() {
    var div = document.querySelector("#imprimirEncuesta").innerHTML;
    var div1 = document.querySelector("#imprimirEncuesta1").innerHTML;
    var div2=document.querySelector('#ImprimirEncuesta3').innerHTML;
    var div3=document.querySelector('#emprimirEncuesta4').innerHTML;
    var div4=document.querySelector('#imprimir5').innerHTML;
    var ventana = window.open('', 'PRINT', 'height=400,width=600');
    ventana.document.write('<html><head><title>Respuestas Individuales</title>');
    ventana.document.write('<link href="assets/css/bootstrap.min.css" rel="stylesheet" type="text/css">');
    ventana.document.write('<link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">');
    ventana.document.write('</head><body>');
    ventana.document.write(div+
        div1+"<br>"+"<br>"+"<br>"+"<br>"+"<br>"+"<br>"+"<br>"+div2+div3+div4);
       ...
       function detalleEncuesta(id) {
           ...
           $.ajax({
               ...
               success: function (response) {
                   ...
                   $.each(response, function (index, val) {
                       $('#user').html(val.email);
                       $('#Precidente_corte').html(val.Presidente_corte);
