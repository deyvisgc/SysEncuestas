...
class EncuestaController extends Controller
{
    ...
    public function index(){
        ...
        $magistrados=DB::select("select * from adminmagistrado");

        $cobranzas=DB::select("SELECT * FROM usuario WHERE idUsuario=$id_tra LIMIT 1
");

        return view('Encuestas.Encuestas',['magistrados'=>$magistrados,'cobran'=>$cobranzas]);
    }
   public function hola(Request $request)
   {
       ...
       try {
           ...
           if ($request->get('servicio_judiciales_SI_1')) {
               $servicios_judiciales->Condicion_uno = $request->get('servicio_judiciales_SI_1');
           } else {
               $servicios_judiciales->Condicion_uno = $request->get('servicio_judiciales_NO_1');
           }

           $servicios_judiciales->Condicion_uno_Observa = $request->servicio_judiciales_Observaciones_1;
           if ($request->get('servicio_judiciales_SI_2')) {
               $servicios_judiciales->Condicion_dos = $request->get('servicio_judiciales_SI_2');
           } else {
               $servicios_judiciales->Condicion_dos = $request->get('servicio_judiciales_NO_2');
           }
           $servicios_judiciales->Condicion_dos_Observa = $request->servicio_judiciales_Observaciones_2;
           if ($request->get('servicio_judiciales_SI_3')) {
               $servicios_judiciales->Condicion_tres = $request->get('servicio_judiciales_SI_3');
           } else {
               $servicios_judiciales->Condicion_tres = $request->get('servicio_judiciales_NO_3');
           }
           ...
           $servicios_judiciales->Usuario_idUsuario = $request->iduser;
           ...
           if ($request->get('auxilio_genereal_SI_2_2')) {
               $auxilio_judicial->Condici_dos_uno = $request->get('auxilio_genereal_SI_2_2');
           } else {
               $auxilio_judicial->Condici_dos_uno = $request->get('auxilio_genereal_NO_2_2');
           }

           $auxilio_judicial->auxi_Judi_Condici_dos_uno_Observa = $request->auxilio_genereal_Observaciones_2_2;
           if ($request->get('auxilio_genereal_SI_3')) {
               $auxilio_judicial->auxi_Judi_Condici_tres = $request->get('auxilio_genereal_SI_3');
           } else {
               $auxilio_judicial->auxi_Judi_Condici_tres = $request->get('auxilio_genereal_NO_3');
           }
           $auxilio_judicial->auxi_Judi_Condici_tres_Observa = $request->auxilio_genereal_Observaciones_3;

           if ($request->get('auxilio_genereal_SI_4')) {
               $auxilio_judicial->auxi_Judi_Condici_cuatro = $request->get('auxilio_genereal_SI_4');
           } else {
               $auxilio_judicial->auxi_Judi_Condici_cuatro = $request->get('auxilio_genereal_NO_4');
           }
           $auxilio_judicial->auxi_Judi_Condici_cuatro_Observa = $request->auxilio_genereal_Observaciones_4;

           if ($request->get('auxilio_genereal_SI_5')) {
               $auxilio_judicial->auxi_Judi_Condici_cinco = $request->get('auxilio_genereal_SI_5');
           } else {
           ...
           if ($request->get('Peritos_judiciales_SI_1')) {
           ...
           if ($request->get('Peritos_judiciales_SI_2_1')) {
           ...
           if ($request->get('Peritos_judiciales_SI_2_2')) {
           ...
           if ($request->get('Peritos_judiciales_SI_3')) {
           ...
           if ($request->get('Peritos_judiciales_SI_4')) {
           ...
           if ($request->get('Peritos_judiciales_SI_5')) {
           ...
           if ($request->get('Peritos_judiciales_SI_6_1')) {
           ...
           if ($request->get('Peritos_judiciales_SI_7')) {
           ...
           if ($request->get('Cuerpo_delito_efectos_SI_1')) {
           ...
           if ($request->get('Cuerpo_delito_efectos_SI_2_1')) {
           ...
           if ($request->get('Cuerpo_delito_efectos_SI_2_2')) {
           ...
           if ($request->get('Cuerpo_delito_efectos_SI_3')) {
           ...
           if ($request->get('Cuerpo_delito_efectos_SI_4_1')) {
           ...
           if ($request->get('Cuerpo_delito_efectos_SI_4_2')) {
           ...
           if ($request->get('Cuerpo_delito_efectos_SI_5')) {
           ...
           $cuerpos_delito->Cuerpos_Condicion_cinco_Observa = $request->Cuerpo_delito_efectos_Observaciones_5;
           if ($request->get('Cuerpo_delito_efectos_SI_6')) {
           ...
           $cuerpos_delito->Cuerpos_Condicion_Seis_Observa = $request->Cuerpo_delito_efectos_Observaciones_6;
           ...
           if ($request->get('Recaudacion_judicial_SI_1')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_2')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_2_1')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_2_2')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_2_3')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_3')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_3_1')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_3_2')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_4')) {
           ...
           if ($request->get('Recaudacion_judicial_S1_4_1')) {
           ...
           if ($request->get('Recaudacion_judicial_SI_5')) {
           ...
           if ($request->get('Cobransas_certificados_SI_1')) {
           ...
           if ($request->get('Cobransas_certificados_SI_1_1')) {
           ...
           if ($request->get('Cobransas_certificados_SI_2')) {
               $cobranza_multa->Condicion_dos_Respuesta_Negativa = $request->Cobransas_certificados_SI_2;
           } else {
               $cobranza_multa->Condicion_dos_Respuesta_Negativa = $request->Cobransas_certificados_N0_2;
           }

           if ($request->get('Cobransas_certificados_SI_2_1')) {
           ...
           if ($request->get('Cobransas_certificados_SI_2_2')) {
           ...
           if ($request->get('Cobransas_certificados_SI_2_3')) {
           ...
           if ($request->get('Cobransas_certificados_SI_2_4')) {
           ...
           if ($request->get('Cobransas_certificados_SI_2_5')) {
           ...
           if ($request->get('Cobransas_certificados_SI_3')) {
           ...
           if ($request->get('Cobransas_certificados_SI_3_1')) {
           ...
           if ($request->get('Cobransas_certificados_SI_3_2')) {
           ...
           if ($request->get('Cobransas_certificados_SI_4')) {
           ...
           $cobranza_multa->Usuario_idUsuario = $request->Usuario_idUsuario = $request->iduser;
           $cobranza_multa->save();



           $user=User::find($id_tra);
           $user->estado=0;
           $user->save();
           DB::commit();
       } catch (Exception $e) {
   ...
   public function Buscar($id){
        $subadmin=DB::select("select * from subaministracion");
       $magistrados=DB::select("SELECT adminmagistrado.idMagistrados,adminmagistrado.idsubAdmins,subaministracion.id_subAministracion,subaministracion.organo_judicial FROM adminmagistrado,subaministracion WHERE adminmagistrado.idsubAdmins=subaministracion.id_subAministracion and adminmagistrado.idMagistrados=$id");
       return response()->json(array('subadmin'=>$subadmin,'magistrados'=>$magistrados));



   }
   public function pdf(){
       $data=Administrativa::all();

       $pdf =PDF::loadView('Admin.DetalleEncuesta');
