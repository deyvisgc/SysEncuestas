...
class Aspectos_Generales extends Model
{
    ...
    protected $fillable = [
        ...
        'Aspect_Gene_Otros_Defi','Aspect_Gene_Cedido_1','Aspect_Gene_Cedido_2','Aspec_Gene_Estructuras_Acc',

        'Aspec_Gene_Puertas_Acc','Aspect_Gene_Ventanas_Acc', 'Aspect_Gene_Pisos_Acc',
        'Aspect_Gene_Pintura_Acc','Aspect_Instalaciones_sanitarias_Acc', 'Aspect_Gene_Electricas_Acc',
        'Aspect_Gene_Brinsa_Seguridad_Acc','Aspect_Gene_Otros_Acc',
        'Aspect_Gene_Cedido_3','Aspect_Gene_Alquilado_1','Aspect_Gene_Alquilado_2','Aspect_Gene_Alquilado_3',
        'Usuario_idUsuario',
    ];
}
